...
class BeginningTheSearch < Neo::Koan
  ...
  def test_using_built_ins
    ...
    assert_equal __, array.size
    assert_equal array[__], array.last
    assert_equal array[__], array.first
    assert_equal __, array[5]
    assert_equal __, array[20]
    assert_equal __, array[40]

    # use #find_index to return the array index of a value
    assert_equal __, array.find_index(50)

    # you can also use #index
    assert_equal __, array.index(50)
    assert_equal __, array.index(20)

    # use #include? if you don't care about the location
    assert_equal __, array.include?(20)
    assert_equal __, array.include?(200)
  end
  ...
  def test_find_index_with_while
    ...
    assert_equal __, find_index_with_while(array, 200)
    assert_equal __, find_index_with_while(rando, 200)
  end
  ...
  def test_find_index_with_each
    ...
    assert_equal __, find_index_with_each(array, 200)
    assert_equal __, find_index_with_each(rando, 200)
  end
